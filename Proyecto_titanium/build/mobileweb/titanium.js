...
var require = {
	app: {
		analytics: true,
		copyright: "2016 by neytu",
		deployType: "development",
		description: "",
		guid: "f82c755e-0b45-43fe-9fff-c5b9749c89cd",
		id: "filesystem.com",
		name: "filesystem",
		names: {},
		publisher: "neytu",
...
require("Ti/App/Properties", function(p) {
	...
	p.setString("appc-app-id","56fc89b59ab9f9b72639c069");
	p.setString("acs-authbase-url-development","https://secure-identity.cloud.appcelerator.com");
	p.setString("acs-base-url-development","https://api.cloud.appcelerator.com");
	p.setString("acs-oauth-secret-development","lCHYJGW8iXqRccn9QEC0pynxxdryNA7g");
	p.setString("acs-oauth-key-development","c0otKunNSVq0wx62BIOWC6ZnKv9aGzbn");
	p.setString("acs-api-key-development","IVYncAfeUdbjiqsulZ0orzybXP59OOLq");
	p.setString("acs-username-development","appc_app_user_dev");
	p.setString("acs-password-development","FkvHWxk8BEYgwWxlNr");
	p.setString("acs-authbase-url-production","https://secure-identity.cloud.appcelerator.com");
	p.setString("acs-base-url-production","https://api.cloud.appcelerator.com");
	p.setString("acs-oauth-secret-production","51rPuSk6Y4Cu25sGX6B0Luwms6OwKKOp");
	p.setString("acs-oauth-key-production","VmKXgEP0mDu75p9m0syLwthvkLENL4hw");
	p.setString("acs-api-key-production","rWGhZPSqfQM8pk11VQIhZqkHXDmRaagd");
	p.setString("acs-username-production","appc_app_user");
	p.setString("acs-password-production","KiaLqNhBbsRvgcuyfT");
	p.setString("appc-org-id","100104797");
	p.setString("appc-creator-user-id","11e2b349-86a7-4d20-8ace-3b11624793b0");
});
